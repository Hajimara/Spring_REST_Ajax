    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/resources/index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Hajimara</b> PROJECT</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="/resources/dist/img/ScreenShot_20171113151612.png" class="user-image" alt="User Image"/>
                  <span class="hidden-xs">Park Sujin</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="/resources/dist/img/ScreenShot_20171113151612.png" class="img-circle" alt="User Image" />
            </div>
